...
$go=$_POST['go_to'];
echo "<script> document.location.href='give_element.php?id=$go'</script>"; 
...
$strSQL="SELECT *  FROM give_element_gen  ORDER BY   id DESC  ";
...
echo "<td  'width=40 bgcolor='white' id='pole_id' > <font color='black'   $sizefont1> <b>"   .  $row['contractor']  .         "  </td>";
