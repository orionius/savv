...
///// шапка талицы
$name =  array('Расх нак','Счет','Дата','Заказчик','Сумма','Примечание' )  ;
$long =  array('100',' 100','100  ','300','100','600        ') ;
...
$strSQL="SELECT *  FROM account_pay  ORDER BY   id_pay DESC  ";
...
$dates=$row['dates'] ;  $dates=date("d.m.Y",strtotime($dates));
...
echo "<td  'width=40 bgcolor='LightYellow' id='pole_nacc' > <font color='black'   >   <a href='account.php?id=$id' TARGET='_self '  style='color:DarkBlue;'  >$id_pay</a></td>";

//echo "<td   'width=20 $bgcol id='pole_id' > <font color='black'  $sizefont1> <b>"   . $num_account .         "  </td>";
echo "<td  'width=40 bgcolor='LightYellow' id='pole_nacc' > <font color='black'   >   <a href='account.php?id=$id' TARGET='_self '  style='color:DarkBlue;'  >$id_ac_gen</a></td>";
...
echo "<td  'width=40 $bgcol id='sum_jour' > <font color='black'   >   <a href='account.php?id=$id' TARGET='_self '  style='color:black;'  > <b>  $pay</b></a></td>";
